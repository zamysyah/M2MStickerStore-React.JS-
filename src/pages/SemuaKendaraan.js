...
function SemuaKendaraan() {
  ...
  useEffect(() => {
    ...
    axios.get('/api/products')  // Pastikan backend Anda mengirimkan data produk melalui API ini
      .then(response => {
  ...
  return (
    <div className="bg-gray-50 text-gray-800 flex flex-col min-h-screen">
      <main className="container mx-auto px-6 py-20">
        <h2 className="text-4xl font-extrabold mb-12 text-red-600 text-center">Produk Semua Kendaraan</h2>
        <p className="text-center text-gray-700 mb-12 max-w-3xl mx-auto">
          Berikut adalah produk variasi untuk semua jenis kendaraan kecil hingga besar yang tersedia di toko M2M Stickers.
        </p>
